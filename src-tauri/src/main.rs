...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            asset_manager::asset_toggle_favorite,
            asset_manager::asset_is_favorite,
            asset_manager::asset_get_favorite_ids,
            asset_manager::asset_batch_favorite,
            ...
            asset_manager::asset_get_versions,
            asset_manager::asset_add_version,
            asset_manager::asset_delete_version,
            asset_manager::asset_rename_version,
            asset_manager::asset_switch_version,
